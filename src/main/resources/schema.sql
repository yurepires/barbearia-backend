...
-- Tabela Despesa (Herdando campos de EntidadeBase)
CREATE TABLE despesa (
                         despesa_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
-- Tabela Pagamento (Herdando campos de EntidadeBase)
CREATE TABLE pagamento (
                           ...
                           updated_at TIMESTAMP,
                           updated_by VARCHAR(255),
                           CONSTRAINT fk_pagamento_agendamento FOREIGN KEY (agendamento_id) REFERENCES agendamento(agendamento_id)
);
...
CREATE TABLE historico_atendimento (
                                       ...
                                       updated_at TIMESTAMP,
                                       updated_by VARCHAR(255),
                                       CONSTRAINT fk_historico_pagamento FOREIGN KEY (pagamento_id) REFERENCES pagamento(pagamento_id),
